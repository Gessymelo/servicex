...
public class CategoriaResource {
    ...
    public ResponseEntity<Categoria> buscarCategoria(@PathVariable Long idCategoria){
    ...
    public ResponseEntity<Categoria> atualizarCategoria(@PathVariable Long idCategoria, @RequestBody Categoria categoria){
